    ...
    <section className="py-24 bg-card" data-reveal>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-14 max-w-3xl">
          ...
          <h2 className="font-serif text-5xl text-foreground mb-6">Featured Performance</h2>
          <div className="w-12 h-1 bg-primary" />
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-[1.35fr_0.65fr] gap-8">
          <a href="https://www.instagram.com/reel/C-BMJGaIgM7/" target="_blank" rel="noopener noreferrer" className="relative min-h-[500px] overflow-hidden rounded-[8px] group bg-muted editorial-lift">
            <Image src="/aneesha-web/asset-11.jpg" alt="Aneesha Altaf featured performance" fill sizes="(min-width: 1024px) 62vw, 100vw" className="object-cover transition duration-500 group-hover:scale-[1.03]" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <h3 className="font-serif text-4xl mt-2">Khudsar — Hareem</h3>
            </div>
          </a>

          <div className="flex flex-col justify-between gap-6">
            <div className="bg-background border border-border p-7">
              <h3 className="font-serif text-3xl text-foreground">Khudsar — Hareem</h3>
              <p className="font-sans text-muted-foreground leading-relaxed mt-4">
                A featured screen moment from Aneesha's public Instagram, highlighting her role as Hareem in Khudsar.
              </p>
              <div className="mt-8 grid gap-3">
                <a href="https://www.instagram.com/reel/C-BMJGaIgM7/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-primary px-5 py-3 text-primary-foreground hover:bg-primary/90 transition">
                  <Instagram size={18} />
                  View on Instagram
                </a>
